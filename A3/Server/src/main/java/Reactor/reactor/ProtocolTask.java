...
import TPCServer.ProtocolCallback;
import TPCServer.ServerProtocol;
...
public class ProtocolTask<T> implements Runnable {
	...
	public ProtocolTask(final ServerProtocol<T> protocol, final MessageTokenizer<T> tokenizer, final ConnectionHandler<T> h, final ProtocolCallback<T> c) {
